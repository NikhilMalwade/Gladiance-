...
extension SchedulingViewController: UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    ...
    func setUp(){
        ...
        DevicesCollectionView.register(UINib(nibName: "CheckmarkCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "CheckmarkCollectionViewCell")
...
//            else{
//                let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "daysOfWeekCollectionViewCell", for: indexPath)
...
//               return CGSize(width: CGFloat(width), height: 25.0)
//           }else if collectionView == monthOfYearCollectionView {
//               let width  = (view.frame.width)/6
//               return CGSize(width: CGFloat(width), height: 25.0)
//           }
//           return CGSize(width: 50.0, height: 5.0)
//
//       }
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        if collectionView == daysOfWeekCollectionView  {
